 ...
 ****************************************************************************/
  if (!is_initialized_) {
    ...
    */
    ...
    //debug info
    Debug( "[ukf]: Initialization Completed! ====================" << endl);
 ...
 ****************************************************************************/
  ...
  /**
     * Update the state vector x_ according to the new elapsed time.
      - Time is measured in seconds.
     * Update the process noise covariance matrix P_.
   */
  ...
  //debug info
  Debug( "[ukf]: Prediction Begin: ====================" << endl);

  Prediction(dt);

  //debug info
  Debug( "[ukf]: Prediction Completed! ====================" << endl);
  ...
  ****************************************************************************/
  ...
  //debug info
  Debug( "[ukf]: Correction Begin: ====================" << endl);

  if (meas_package.sensor_type_ == MeasurementPackage::RADAR) {
    // Radar updates

    //debug info
    Debug( "[ukf]: Sensor Type = RADAR ~~~~~~~~~~" << endl);
